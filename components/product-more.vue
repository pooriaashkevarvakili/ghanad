<template>
  <div>
    <div class="flex px-20 justify-between">
      <div class="text-xl">محصولات پرطرفدار</div>
      <img src="line.png" alt="" />
      <div class="text-xl">محصولات بیشتر</div>
    </div>
    <div>
      <div
      ...
      >
        <div class="flex justify-center">
          <div class="rounded-lg shadow-lg bg-white max-w-lg h-80">
            <a href="#!" class="flex items-center justify-center">
              <img class="rounded-t-lg" src="shirininight.png" alt="" />
            </a>
            <div class="p-6">
        ...
        <div class="flex justify-center">
          <div class="rounded-lg shadow-lg bg-white max-w-lg h-80">
            ...
            <div class="p-6">
              ...
              <div style="direction: rtl">هرعدد</div>
              <div class="flex space-x-2">
                <button
                  type="button"
                  class="
        ...
        <div class="flex justify-center">
          <div class="rounded-lg shadow-lg bg-white max-w-lg h-80">
            <a href="#!" class="flex items-center justify-center">
              <img
                class="w-24 h-24 rounded-t-lg"
                src="shiriniseven.png"
                alt=""
              />
            </a>
            <div class="p-6">
