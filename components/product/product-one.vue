  ...
  >
    <div class="flex justify-center">
      <div class="block w-96 h-90 p-6 max-w-sm rounded-lg shadow-lg bg-white">
        ...
        <div class="flex justify-center items-center">
          <p>special chocolate cake</p>
        </div>
        <div class="flex justify-center items-center">
          <p>کیک شکلاتی مخصوص</p>
        </div>
        <div class="flex justify-center items-center">
          <svg
        ...
        <div class="flex mt-4 justify-between">
          ...
          <div class="flex flex-col">
            <div>هراسلایس</div>
            <div class="text-red-400">38000</div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="block w-96 p-6 max-w-sm rounded-lg shadow-lg bg-white">
        ...
        <div class="flex mt-4 justify-between">
          ...
          <div>
            <div class="flex flex-col">
              <div>هراسلایس</div>
              <div class="text-red-400">25000</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div
      ...
      "
    >
      <div class="block w-96 p-6 h-90 max-w-sm rounded-lg shadow-lg bg-white">
        <div class="flex justify-center items-center">
          <img src="shirinieight.png" />
        </div>
        <div class="flex justify-center items-center">
          <p>starwberrychart</p>
        </div>
        ...
        <div class="flex mt-4 justify-between">
          ...
          <div class="flex flex-col">
            <div class="">هر اسلایس</div>
            <div class="text-red-400">30000</div>
          </div>
        </div>
      </div>
    </div>
